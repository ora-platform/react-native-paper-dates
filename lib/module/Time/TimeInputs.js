...
import { clockTypes, inputTypes, toHourInputFormat, toHourOutputFormat } from './timeUtils';
...
function TimeInputs({
  ...
  const useHorizontalAmPm = !is24Hour && isLandscape && inputType === inputTypes.picker;
  ...
  const hourMinuteRow = /*#__PURE__*/_jsxs(View, {
    ...
    }), !is24Hour && !useHorizontalAmPm ? /*#__PURE__*/_jsxs(_Fragment, {
      children: [/*#__PURE__*/_jsx(View, {
  ...
  if (useHorizontalAmPm) {
    return /*#__PURE__*/_jsxs(View, {
      ...
      children: [hourMinuteRow, /*#__PURE__*/_jsx(View, {
        style: styles.landscapeSwitcherSpacing,
        children: /*#__PURE__*/_jsx(AmPmSwitcher, {
          hours: hours,
          onChange: onChangeHours,
          inputType: inputType,
