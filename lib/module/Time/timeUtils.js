...
export function useSwitchColors(highlighted) {
  ...
  const backgroundColor = highlighted ? theme.colors.tertiaryContainer : 'transparent';
  const color = highlighted ? theme.colors.onTertiaryContainer : theme.colors.onSurfaceVariant;
  return {
    backgroundColor,
    color
  };
...
export function useInputColors(highlighted) {
  ...
  const backgroundColor = highlighted ? theme.colors.primaryContainer : theme.colors.surfaceVariant;
  const color = highlighted ? theme.colors.onPrimaryContainer : theme.colors.onSurface;
  return {
    backgroundColor,
    color
  };
