...
import { circleSize, inputTypes, toHourInputFormat, toHourOutputFormat } from './timeUtils';
...
function TimePicker({
  ...
  const inputsWidth = 96 * 2 + 24 + (is24Hour || isLandscape && inputType === inputTypes.picker ? 0 : 12 + 52);
  const clockWidth = inputType === inputTypes.picker ? circleSize + (isLandscape ? 64 : 0) : 0;
